...
Every feature is an opportunity to teach. We do not just show a chart; we explain _what the chart means_ for the user's financial health. We use terminology that is technically correct but explained through contextual tooltips and plain-language summaries.
...
Investments do not exist in a vacuum. We use real historical data from NBP, GUS, and Yahoo Finance to provide context. Instead of just "5% growth," we show "5% growth during a 10% inflation period," highlighting the concept of _real return_.
