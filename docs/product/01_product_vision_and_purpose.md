...
- **Data Veracity:** Eliminate mocked data. Macroeconomic and bond series data must be sourced from official providers such as NBP and GUS, while market benchmark history is seeded from Yahoo Finance into a relational database.
