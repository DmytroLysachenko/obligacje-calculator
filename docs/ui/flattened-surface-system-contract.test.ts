...
describe('flattened shared surface system contract', () => {
  ...
  it('keeps migrated shared surfaces anchored by dividers or left-border emphasis', () => {
    ...
    expect(sourceByPath.get('app/education/EducationClient.tsx')).toContain('grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 lg:grid-cols-3');
    expect(sourceByPath.get('app/education/EducationClient.tsx')).toContain('grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 xl:grid-cols-3');
