...
| ARC-09     | In progress                    | `dcb2da4e feat(ui): centralize quantity formatting` extends locale adapters to general quantities; comparison, education, recurring investment, chart insight, and admin counts use them. Remaining direct user-facing locale calls require audit.                                                                                                                                                                                       |
...
| PERF-03    | In progress                    | Heavy economic, multi-asset, retirement, and portfolio analytics charts now load at their result/interaction boundary with stable loading geometry; bundle analysis and remaining chart/export splits remain.                                                                                                                                                                                                                            |
...
| UI-10      | In progress                    | A repository-wide production-source motion policy now rejects `transition-all` and asserts the global reduced-motion override. Focus-return and outline-equivalence checks remain.                                                                                                                                                                                                                                                       |
