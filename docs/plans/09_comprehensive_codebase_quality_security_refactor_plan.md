...
| COR-01     | In progress | `feat(calculation): finalize versioned cache and workflow ownership` adds explicit cache TTL and namespace invalidation; tax-rule revision and sync-event integration remain.                                                                                                                     |
