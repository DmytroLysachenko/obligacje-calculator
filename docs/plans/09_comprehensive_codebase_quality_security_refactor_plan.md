...
| TEST-09    | In progress                    | Lighthouse uses a portable `/tmp` profile and now records three runs per route under the production-like CI tier. Preview explicitly disables only crawlability while production retains the SEO category gate.                                                                                                                                                                                                                          |
