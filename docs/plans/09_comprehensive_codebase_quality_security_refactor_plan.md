...
| COR-04     | In progress                    | `fix(calculation): enforce versioned session result ownership` documents and tests active-model envelope validation before persisted results are restored; versioned golden fixtures remain.                                                                                                                                                                                                                                             |
