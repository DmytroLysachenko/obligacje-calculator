...
| REL-01     | In progress                    | `fix(calculation): enforce versioned session result ownership` invalidates stale completions and preserves cancellation as a non-success state; component-level interaction coverage remains.                                                                       |
