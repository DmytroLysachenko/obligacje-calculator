...
| 3   | Shared layout & navigation         | application layout, sidebar                       | Anchored desktop and contextual mobile navigation with clear active/focus states; lint, types                     | in progress — checks & diff review complete |
