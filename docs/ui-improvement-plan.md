...
| 4   | Reusable component consistency     | button, card, table, chart frame                  | Controls, surfaces, and data tables share restrained states and rhythm; lint, types                               | in progress — checks & diff review complete |
