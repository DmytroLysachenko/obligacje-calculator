...
| 5   | Forms & interaction states         | form fields, money input, form select             | Readable labels, errors, descriptions, and touch-size controls with no logic change; lint, types, form contracts  | in progress — checks & diff review complete |
