...
| 7   | Secondary calculators              | regular investment, ladder, retirement, optimizer | Consistent control/result layouts and result hierarchy; lint, types, related contracts                            | in progress — checks & diff review complete |
