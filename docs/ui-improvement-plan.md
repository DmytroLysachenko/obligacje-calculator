...
| 6   | Primary calculator                 | single-calculator panels and inputs               | Clearer setup/results hierarchy, calm pending/stale state; lint, types, calculator contracts                      | in progress — checks & diff review complete |
