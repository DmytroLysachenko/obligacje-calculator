...
| ------------------------------------------ | ------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------- |
| A. Capture evidence and protect boundaries | Reproducible failures, honest receipts, bounded inputs | Start F28; implement F27, F07 and F08. Investigate F29. Establish F30 benchmark.                                |
