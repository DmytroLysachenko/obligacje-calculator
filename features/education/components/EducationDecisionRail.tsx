        ...
        <li key={route.key} className="min-w-0">
          <div className="relative h-full">
            <Link
              ...
              className="ui-interactive-surface group flex h-full gap-3 rounded-md border border-border bg-card px-4 py-4 pr-12 hover:border-foreground/30 hover:bg-muted/30 xl:relative xl:block"
            >
              <span
            ...
            <InfoTooltip
              content={t(`education.decision.${route.key}.description`)}
              className="absolute right-2 top-2 bg-card/70"
            />
          </div>
        </li>
      ))}
