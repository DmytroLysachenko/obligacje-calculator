...
describe('bond info panel contract', () => {
  ...
  it('keeps single and recurring calculator bond notes on the shared panel', () => {
    ...
    expect(single).toContain("import { BondInfoPanel } from '@/shared/components/forms/BondInfoPanel';");
    expect(regular).toContain("import { BondInfoPanel } from '@/shared/components/forms/BondInfoPanel';");
