...
export default function RecoveryLabPage() {
    ...
    return (<div className="space-y-8">
      ...
      <FeatureStatusNotice status="experimental" eyebrow={t("generated.app.recovery_lab.page.item_2")} title={t('landing.recovery_lab_page.why_separated')}>
        {t('landing.recovery_lab_page.why_separated_desc')}
      </FeatureStatusNotice>

      <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
        {recoveryLabPages.map((page) => (<Link key={page.href} href={page.href} className="group block h-full">
